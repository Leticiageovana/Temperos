...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 30-Jun-2023 às 15:18
...
CREATE TABLE `carinho_itens` (
  `id_carinho_itens` int(11) NOT NULL,
...
--
-- Estrutura da tabela `historico de compra`
--

CREATE TABLE `historico de compra` (
...
--
ALTER TABLE `carinho_itens`
  MODIFY `id_carinho_itens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `pedido_produto`
  MODIFY `id_pedido_produto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
